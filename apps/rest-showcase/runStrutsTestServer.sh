...
RIVULET_CORE_JAR="${M2_REPO}/io/rivulet/rivulet-core/1.0.0/rivulet-core-1.0.0.jar"
SERVER_JAR="${M2_REPO}/io/rivulet/embedded-server/1.0.0/embedded-server-1.0.0.jar"
...
#JAVA_FLAGS="${JAVA_FLAGS} -Xrunjdwp:transport=dt_socket,server=y,suspend=y,address=5005"
